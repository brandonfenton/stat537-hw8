...
```{r p2_a, dependon="p1_b", fig.width=3}
fa.varimax <- fa(tc2, rotate="varimax", nfactors=2)
fa.diagram(fa.varimax, simple=T)
```

There are no temperatures in MR2. MR1 isn not exclusively temperatures; it also has precipitations in the late spring and summer (except June???) and some snowpacks (typically in warmer months). Maybe MR2 is "snow-in-ya-face" and MR1 is "hows-it-feelin'-outside".
