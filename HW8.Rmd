...
The pattern of which variables are associated with which factors has not changed from problem 2, so the factors can still be described as "overall temperature" and "winteriness." The big difference is that the simple=F option allows
