...
pander(top.uv2, caption = "First 8 Uniquenesses")
```

The uniquenesses do not change because the rotation is simply a change of basis which can change the factors a variable is associated with but does not affect the amount of variation explained by all the factors.
...
By default, loadings less than 0.3 in absolute value are not shown.
