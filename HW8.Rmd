...
knitr::opts_chunk$set(echo=F, warning=F, message=F, cache=T, comment=NA, size="fotnotesize", fig.width=6, fig.height=4, fig.align="center", dev="pdf", dev.args=list(pointsize=8))
...
```{r p2_b, echo=F, warning=F, message=F, cache=T, fig.height=8, fig.width=8}
